...
public class SearchNameActivity extends Activity {
                  ...
                  case 1:   
					try {
						if(jsonObject!=null && jsonObject.getInt("key") == 1){
							...
							MyAdapter adapter = new MyAdapter(SearchNameActivity.this);
                  ...
                  case 2:
					try {
						if(jsonObject2!=null && jsonObject2.getInt("key") == 1){
				         		...
				         		intent.setClass(SearchNameActivity.this, OneChemActivity.class);
    ...
    class Mythread implements Runnable{
		...
		public void run() {
			...
			jsonObject = SQLiteApi.getJsonObject("GetList", map, SearchNameActivity.this);
    ...
    class Mythreadmsg implements Runnable{
		...
		public void run() {
			...
			try {
				...
				jsonObject2 = SQLiteApi.getJsonObject("GetBasic", map, SearchNameActivity.this);
				Message message = new Message();   
				message.what = 2;      
				myHandler.sendMessage(message);   
			} catch (JSONException e) {
