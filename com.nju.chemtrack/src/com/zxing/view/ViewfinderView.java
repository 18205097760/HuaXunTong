...
//      canvas.drawRect(frame.left, frame.bottom - 1, frame.right + 1, frame.bottom + 1, paint);
      	int linewidht = 10;
	    //»­ËÄ¸ö½ÇµÄ´úÂë<br>paint.setColor(frameColor);
      ...
      int vmiddle =( frame.left + frame.right ) / 2;

      canvas.drawRect(vmiddle - 20, middle - 2, vmiddle + 20, middle + 2, paint);
      canvas.drawRect(vmiddle - 2 , middle - 20, vmiddle + 2, middle + 20, paint);
